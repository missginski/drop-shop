...
// pass in input. input = location on db
...
// can you pass a db value to a function? of course..
  ...
  let getProduct = function(){
    $.ajax({
      url: 'http://api.shopstyle.com/api/v2/products?pid=uid3841-22532279-49&format=JSON&fts=ankle+boots&offset=' + (Math.floor(Math.random() * (50 - 1)) + 1) +'&limit=1',
      method: 'GET',
      dataType: 'json',
        success: function(data){
